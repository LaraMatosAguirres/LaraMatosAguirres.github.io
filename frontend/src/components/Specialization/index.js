...
const Specialization = () => {
    // Refs para animações internas
    const textRef = useScrollAnimation('fadeInLeft', 0.3, 200);
    const imageRef = useScrollAnimation('fadeInRight', 0.3, 400);
    const playButtonRef = useScrollAnimation('fadeIn', 0.3, 300);
    const skillsRef1 = useScrollAnimation('fadeInUp', 0.3, 500);
    const skillsRef2 = useScrollAnimation('fadeInUp', 0.3, 600);
    const skillsRef3 = useScrollAnimation('fadeInUp', 0.3, 700);

    return (
        <div className="specialization-container">
            <div id="carouselSpecializationControls" className="carousel slide carousel-fade carousel-animate" data-bs-ride="carousel">
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <div className="carrosel-styles">
                            <div 
                                ref={textRef}
                                className="texto-specialization-container animate-element fadeInLeft"
                            >
                                <h1>Como trabalho?</h1>
                            ...
                            <div 
                                ref={imageRef}
                                className="minha-foto animate-element fadeInRight"
                            >
                                <MinhaFoto />
                            </div>
                        </div>
                    ...
                    <div className="carousel-item">
                        <div className="texto-container-quem-sou-eu">
                            ...
                            <div className="texto-quem-sou-eu">
                                <div 
                                    ref={playButtonRef}
                                    className="play-imagem animate-element fadeIn"
                                >
                                ...
                                <div 
                                    ref={skillsRef1}
                                    className="aprender-container animate-element fadeInUp delay-100"
                                >
                                    <h2>Aprender</h2>
                                ...
                                <div 
                                    ref={skillsRef2}
                                    className="aprender-container animate-element fadeInUp delay-200"
                                >
                                    <h2>Resiliencia</h2>
                                ...
                                <div 
                                    ref={skillsRef3}
                                    className="caracterisca-container animate-element fadeInUp delay-300"
                                >
                                    <h2>Iniciativa</h2>
